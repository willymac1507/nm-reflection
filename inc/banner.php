    ...
    <div class="carousel__main">
        <div class="carousel">
            ...
            <div class="carousel__container carousel--bespoke">
                ...
                <div class="button button--cta">find out more
        ...
        <div class="carousel">
            ...
            <div class="carousel__container carousel--it">
                ...
                <div class="button button--cta cta--it">find out more
                    <span class="right-arrow"></span>
                </div>
            </div>
        </div>
        <div class="carousel">
            ...
            <div class="carousel__container carousel--marketing">
                ...
                <div class="button button--cta cta--marketing">find out more
                    <span class="right-arrow"></span>
                </div>
            </div>
        </div>
        <div class="carousel">
            ...
            <div class="carousel__container carousel--telecoms">
                ...
                <div class="button button--cta cta--telecoms">find out more
                    <span class="right-arrow"></span>
                </div>
            </div>
        </div>
        <div class="carousel">
            ...
            <div class="carousel__container carousel--web">
                ...
                <div class="button button--cta cta--web">find out more
                    <span class="right-arrow"></span>
                </div>
            </div>
        </div>
        <div class="carousel">
            ...
            <div class="carousel__container carousel--security">
                ...
                <div class="button button--cta cta--security">find out more
                    <span class="right-arrow"></span>
                </div>
            </div>
        </div>
